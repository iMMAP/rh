    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indicator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rh.indicator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility_site_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rh.facilitysitetype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(blank=True, choices=[('todo', 'Todo'), ('pending', 'Pending'), ('submit', 'Submitted'), ('reject', 'Rejected'), ('complete', 'Completed')], default='todo', max_length=15, null=True)),
