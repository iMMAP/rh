...
class ReportsExportView(View):
    ...
    def write_project_report_sheet(self, workbook, project_reports):
        ...
        columns = [
            ...
            {"header": "Project Code", "type": "string", "width": 20},
            {"header": "Project Title", "type": "string", "width": 20},
            ...
            {"header": "Focal Person Email", "type": "string", "width": 20},
            {"header": "Implementing Partners", "type": "string", "width": 20},
            {"header": "Donors", "type": "string", "width": 20},
            ...
            {"header": "Activity Domain", "type": "string", "width": 40},
            {"header": "Activity Type", "type": "string", "width": 40},
            {"header": "Activity Detail", "type": "string", "width": 40},
            {"header": "Indicator", "type": "string", "width": 20},
        ...
        self.write_sheet_columns(sheet, columns)
        self.write_project_report_data_rows(sheet, project_reports)
    ...
    def write_project_report_data_rows(self, sheet, project_reports):
        """
        Write project data rows to the sheet.
                ...
                for plan_report in plan_reports:
                    ...
                    for location_report in location_reports:
                        rows.append([
                            ...
                            ", ".join(str(cluster.title) for cluster in report.project.clusters.all()) if report.project.clusters else None,
                            report.project.user.profile.name if report.project.user and report.project.user.profile else None,
                            report.project.user.profile.phone if report.project.user and report.project.user.profile else None,
                            report.project.user.email if report.project.user else None,
                            ", ".join(str(partner.name) for partner in report.project.implementing_partners.all()) if report.project.implementing_partners else None,
                            ", ".join(str(donor.name) for donor in report.project.donors.all()) if report.project.donors else None,
                            ...
                            ", ".join(str(report_type.name) for report_type in plan_report.report_types.all()) if plan_report.report_types else None,
