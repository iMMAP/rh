...
def project_filter_export_view(request, projectId):
        ...
        for plan in plans:
            ...
            for location in locations:
                ...
                row = [
                    ...
                    plan.activity_domain.name if "activity_domain" in selectedData and plan.activity_domain else None,
                    plan.activity_type.name if "activity_type" in selectedData and plan.activity_type else None,
                    plan.activity_detail.name if "activity_detail" in selectedData and plan.activity_detail else None,
                    ...
                    plan.hrp_beneficiary.name if "hrp_beneficiary" in selectedData and plan.hrp_beneficiary else None,
