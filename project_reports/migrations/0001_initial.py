...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(blank=True, choices=[('todo', 'Todo'), ('pending', 'Pending'), ('approve', 'Approved'), ('reject', 'Rejected'), ('complete', 'Complete')], default='draft', max_length=15, null=True)),
