...
urlpatterns = [
    ...
    path('projects/archived/', user_views.archived_projects_view, name='archived_projects'),
    ...
    path('project/project_plan/archive/<str:pk>/', user_views.archive_project, name='archive_project'),
    path('project/project_plan/unarchive/<str:pk>/', user_views.unarchive_project, name='unarchive_project'),
    ...
    path('project/activity_plan/copy/<str:project>/<str:plan>/', user_views.copy_activity_plan, name='copy_plan'),
    path('project/activity_plan/delete/<str:pk>/', user_views.delete_activity_plan, name='delete_plan'),
    ...
    # Exports
    path('export-excel/', export_views.ProjectExportExcelView.as_view(), name='export_project_excel'),
