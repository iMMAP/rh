...
class TargetLocationReport(models.Model):
    ...
    country = models.ForeignKey(Location, related_name='target_report_country', on_delete=models.SET_NULL, null=True,
                                blank=True)
    province = models.ForeignKey(Location, related_name='target_report_province', on_delete=models.SET_NULL, null=True,
                                 blank=True)
    district = models.ForeignKey(Location, related_name='target_report_district', on_delete=models.SET_NULL, null=True,
                                 blank=True)
    zone = models.ForeignKey(Location, related_name='target_report_zones', on_delete=models.SET_NULL, null=True,
                                 blank=True)
