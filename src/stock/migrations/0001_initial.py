    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "qty_in_stock",
                    models.IntegerField(blank=True, default=0, null=True, verbose_name="Qty in Stock"),
                ),
                (
                    "qty_in_pipeline",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock_location_details",
                    models.ManyToManyField(to="stock.stocklocationdetails"),
                ),
            ],
            options={
