# Generated by Django 4.0.6 on 2023-04-16 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rh.location')),
                ('districts', models.ManyToManyField(related_name='districts', to='rh.location')),
                ...
                ('provinces', models.ManyToManyField(related_name='provinces', to='rh.location')),
