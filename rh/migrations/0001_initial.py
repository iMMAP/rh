    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "old_id",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Old ID"),
                ),
                ("clusters", models.ManyToManyField(blank=True, to="rh.cluster")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "activity_domains",
                    models.ManyToManyField(related_name="activity_domains", to="rh.activitydomain"),
                ),
                (
                    "budget_currency",
                    models.ForeignKey(
                ...
                (
                    "programme_partners",
                    models.ManyToManyField(related_name="programme_partners", to="rh.organization"),
                ),
                (
                    "user",
                    models.ForeignKey(
