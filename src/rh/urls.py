...
urlpatterns = [
    ...
    path("projects/export-ap-import-template/<int:pk>", projects.export_activity_plans_import_template, name="projects-ap-import-template"),
    path("projects/import-activity-plans/<int:pk>", projects.import_activity_plans, name="projects-import-activity-plans"),
